...
import com.ssmhdssmhd.mxboxs.event.ActionEvent;
import com.ssmhdssmhd.mxboxs.receiver.ActionReceiver;
...
public class PiP {
    ...
    public void update(Activity activity, boolean play) {
        try {
            ...
            actions.add(buildRemoteAction(activity, com.ssmhdssmhd.mxboxs.R.drawable.ic_action_audio, R.string.exo_controls_hide, ActionEvent.AUDIO));
