package com.ssmhdssmhd.android.tv.utils;
...
import com.ssmhdssmhd.android.tv.receiver.ActionReceiver;
...
public class PiP {
    ...
    public void update(Activity activity, boolean play) {
        try {
            ...
            actions.add(buildRemoteAction(activity, com.ssmhdssmhd.android.tv.R.drawable.ic_action_audio, R.string.exo_controls_hide, ActionEvent.AUDIO));
