...
import com.ssmhdssmhd.mxboxs.bean.Backup;
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public static void backup() {
        backup(new com.ssmhdssmhd.mxboxs.impl.Callback());
    }

    public static void backup(com.ssmhdssmhd.mxboxs.impl.Callback callback) {
        Task.execute(() -> {
    ...
    public static void restore(File file, com.ssmhdssmhd.mxboxs.impl.Callback callback) {
        Task.execute(() -> {
